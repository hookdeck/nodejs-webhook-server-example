...
router.post('/paddle-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(qs.parse(decodeURIComponent((req.body as any).toString())));
  res.send('Paddle Successfully received Webhook request');
});

router.post('/checkout-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Checkout Successfully received Webhook request');
});

// CI/CD
router.post('/github-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('GitHub Successfully received Webhook request');
});

router.post('/gitlab-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Gitlab Successfully received Webhook request');
});

router.post('/bitbucket-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Bitbucket Successfully received Webhook request');
});

router.post('/docker-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Docker Successfully received Webhook request');
});

// E-COMM
router.post('/shopify-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Shopify Successfully received Webhook request');
});

router.post('/bigcommerce-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('BigCommerce Successfully received Webhook request');
});

router.post('/woocommerce-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('WooCommerce Successfully received Webhook request');
});

router.post('/commercelayer-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Commerce Layer Successfully received Webhook request');
});

// CRM
router.post('/hubspot-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('HubSpot Successfully received Webhook request');
});

router.post('/pipedrive-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
  res.send('Pipedrive Successfully received Webhook request');
});

// EXTRAS
router.post('/okta-webhooks-endpoint', verifyHookdeckSignature, (req: Request, res: Response) => {
  console.log(req.body);
